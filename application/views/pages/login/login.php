...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('resources/') ?>index2.html">Poliklinik</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body kotak">
    ...
    <?php echo form_open(base_url('login/auth'), 'post'); ?>
      <div class="form-group has-feedback">
        <input type="text" class="form-control inputan" placeholder="Username" name="username">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control inputan" placeholder="Password" name="password">
