    ...
    <section class="content">
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-sm-4" style="padding-left:20px; ">
              <h4>No : <?php echo $this->uri->segment(3) ?></h4>
        ...
        <div class="box-footer">
          <button class="btn btn-dafault pull-left">Batal</button>
          <button class="btn btn-success pull-right" onclick="selesai()">Selesai</button>
        </div>
      </div>
      <div id="wrap-katpas">
        <div class="row">
